 ...
 * @i: integer to get absolute value for
 *
...
/**
 * get_numbase_len - gets length buffer needed for unsigned int
...
/**
 * fill_numbase_buff - fills buffer with correct numbers to base 36
 * @num: number to convert to string given base
 * @base: base of number used in conversion, only works to base 36
 * @buff: buffer to fill result of conversion
